...
def run() -> None:
    ...
    try:
        ...
        print("[ERR] You need a 'credentials.json' file with a key called 'token'. This should be your bot api token.")
        exit(1)
    except KeyError:
